...
export function SimpleLog({ initialLogs, initialTab = "log", sinceLabel }: { initialLogs: LogRecord[]; initialTab?: Tab; sinceLabel?: string }) {
  ...
  function selectTab(next: Tab) {
    ...
    if (next === "log") params.delete("view");
  ...
  return <main>
    ...
    {tab === "calendar" ? <CalendarView logs={logs} sinceLabel={sinceLabel} /> : tab === "log" ? <section className="workspace">
