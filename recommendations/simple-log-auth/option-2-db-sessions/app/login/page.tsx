  ...
  return (
    <main style={{ margin: "15vh auto", maxWidth: 420, padding: 24 }}>
      ...
      <form action={login} className="composer" style={{ marginTop: 32, padding: 20 }}>
        ...
        <input autoComplete="current-password" autoFocus id="password" maxLength={1_024} name="password" required type="password" style={{ display: "block", width: "100%", margin: "8px 0 16px", padding: 12 }} />
